# Generated by Django 5.2.4 on 2025-12-22 07:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('schools', '0003_class'),
        ('superadmin', '0007_parent_user_student_user_teacher_user'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resources', to='superadmin.lesson', verbose_name='Lesson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='superadmin.lesson', verbose_name='Lesson')),
            ],
            options={
